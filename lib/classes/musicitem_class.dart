...
class MusicItem {
  ...
  String get title => _title ?? mediaItem.title;
  Future<UserClass> get artist async => fc.getUser(_artistId ?? "US000000000");
  String get artistUsername => _artistUsername ?? "Unknown musicial";
