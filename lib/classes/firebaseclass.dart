...
class FirabaseClass {
  ...
  Future<void> getPlaylist(String id) async {
    if (!id.contains("PL")) return;
  }

  Future<String> getMusicianName(String id) async {
    for (MusicianClass musician in listOfMusicians) {
      if (musician.id == id) {
  ...
  Future<void> getMusicItem(String id) async {}
}
